  ...
  return (
    <section className="overflow-hidden mx-auto relative min-h-[100vh]">
      ...
      >
        ...
        <p
          className={`text-[#FFFFFF99] text-center mx-auto max-w-sm px-3 text-sm font- font-medium`}
        >
          No external page for your request.
        </p>
        ...
        >
          <motion.button
            ...
            className={`bg-primary-gradient  px-[22.8px] py-[14.85px] text-[14.5px] font-medium font-clash`}
          >
            Back to home
          </motion.button>
        </Link>
